...
const ProductDetailsPage = () => {
  ...
  // const handleContentSwitch = (event: any) => {
  //   event.target.innerText === "About"
  //     ? setCurrentContent(Content.About)
  //     : setCurrentContent(Content.Details);
  //   console.log(event);
  // };
    ...
    <>
      ...
      <main className="bg-light-grey">
        ...
        <div className="bg-white">
          <Container className="py-2 px-5 text-dark-green ">
        ...
        <div className="bg-light-grey">
          <Container style={{ height: "500px" }} className="bg-info px-5">
